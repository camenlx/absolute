...
static const int MAX_OUTBOUND_CONNECTIONS = 4; //8
/** Maximum number if outgoing masternodes */
static const int MAX_OUTBOUND_MASTERNODE_CONNECTIONS = 10; //20
/** -listen default */
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 24; //125
...
static const size_t DEFAULT_MAXRECEIVEBUFFER = 5 * 300; //5 * 1000
static const size_t DEFAULT_MAXSENDBUFFER    = 1 * 300; //1 * 1000
